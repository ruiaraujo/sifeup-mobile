 ...
 *
 */
public class AcademicPathFragment extends BaseFragment implements ResponseCommand {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		AcademicPathUtils.getAcademicPathReply(SessionManager.getInstance().getLoginCode(), this);
	...
	public void onResultReceived(Object... results) {
		...
		average.setText(getString(R.string.path_average, academicPath.getAverage()));
		year.setText(getString(R.string.path_year, academicPath.getCourseYears()));
	...
	private class AcademicPathAdapter extends BaseExpandableListAdapter {
		...
		public Object getChild(int groupPosition, int childPosition) {
			...
			if ( childPosition <= year.getFirstSemester().size() + 1  )
				...
				uc = year.getSecondSemester().get(childPosition-2-year.getFirstSemester().size());
			return uc;
		}
		...
		public int getChildrenCount(int groupPosition) {
			...
			AcademicYear year = academicPath.getUcs().get(groupPosition);
			return year.getFirstSemester().size() + year.getSecondSemester().size() + 2;
		}

		public Object getGroup(int groupPosition) {
			return getString(R.string.path_year, academicPath.getUcs().get(groupPosition).getYear()-academicPath.getBaseYear()+1);
		}
