...
public class AcademicPathFragment extends BaseFragment implements
	...
	public void onResultReceived(Object... results) {
		...
		average.setText(getString(R.string.path_average, academicPath
				.getAverage()));
		year.setText(getString(R.string.path_year, academicPath
				.getCourseYears()));
	...
	private class AcademicPathAdapter extends BaseExpandableListAdapter {
		...
		public View getChildView(int groupPosition, int childPosition,
			...
			if (uc == null) {
				...
				marker.setPadding(marker.getPaddingLeft() + 16, marker
						.getPaddingTop(), marker.getPaddingRight(), marker
						.getPaddingBottom());
		...
		public Object getGroup(int groupPosition) {
			return getString(R.string.path_year, academicPath.getUcs().get(
					groupPosition).getYear()
