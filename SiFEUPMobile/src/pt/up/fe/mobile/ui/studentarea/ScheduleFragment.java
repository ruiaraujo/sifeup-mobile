...
public class ScheduleFragment extends BaseFragment implements
    ...
    /**
     * Schedule Parser Stores Blocks in ScheduleFragment.schedule Returns true
        ...
        protected String doInBackground(Void... code) {
            ...
            try {
                ...
                case SCHEDULE_STUDENT:
                    page = SifeupAPI.getScheduleReply(scheduleCode, firstDay,
                            lastDay);
                    break;
                case SCHEDULE_EMPLOYEE:
                    page = SifeupAPI.getEmployeeScheduleReply(scheduleCode,
                            firstDay, lastDay);
                    break;
                case SCHEDULE_ROOM:
                    page = SifeupAPI.getRoomScheduleReply(
                            scheduleCode.substring(0, 1),
                            scheduleCode.substring(1), firstDay, lastDay);
                    break;
                case SCHEDULE_UC:
                    page = SifeupAPI.getUcScheduleReply(scheduleCode, firstDay,
                            lastDay);
                    break;
                default:
                    page = null;
