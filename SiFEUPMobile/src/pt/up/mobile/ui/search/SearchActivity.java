...
import pt.up.mobile.ui.BaseMultiPaneActivity;
...
public class SearchActivity extends BaseSinglePaneActivity {
	...
	protected void onNewIntent(Intent query) {
		...
		getSupportFragmentManager().beginTransaction()
				.replace(R.id.root_container, searchFragment).commit();
	}
	...
	public static void clearSearchHistory(Context context) {
		SearchRecentSuggestions suggestions = new SearchRecentSuggestions(
				context, SearchSuggestionHistory.AUTHORITY,
				SearchSuggestionHistory.MODE);
