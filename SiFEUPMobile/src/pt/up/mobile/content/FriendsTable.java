...
public class FriendsTable implements BaseColumns {
	...
	private static final String TABLE_CREATE = "CREATE TABLE " + TABLE + " ("
			+ KEY_ID_FRIEND + " INTEGER PRIMARY KEY AUTOINCREMENT, "
			+ KEY_CODE_FRIEND + " TEXT NOT NULL, " + KEY_NAME_FRIEND
			+ " TEXT NOT NULL, " + KEY_TYPE_FRIEND + " TEXT NOT NULL, "
			+ KEY_COURSE_FRIEND + " TEXT DEFAULT NULL, " + KEY_USER_CODE
			+ " TEXT NOT NULL );";
